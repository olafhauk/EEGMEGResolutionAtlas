...
E.g.: run WH_Res_SensitivityMaps.py WH_MNE_Resolution_config 13 SensMap RMS
=========================================================
...
for sbj in sbj_ids:
    ...
    for (eeg,meg,modal) in [(True,True,'EEGMEG'), (False,True,'MEG'), (True,False,'EEG')]:
        ...
        stc = R.sensitivity_map(fwd_use, noise_cov_use, diag=True, metric=metric, maxnorm=False)
